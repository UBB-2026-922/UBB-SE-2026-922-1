// <copyright file="BeneficiariesViewModelTests.cs" company="CtrlC CtrlV">
// Copyright (c) CtrlC CtrlV. All rights reserved.
// </copyright>
// <summary>
// Contains tests for the BeneficiariesViewModel class.
// </summary>
...
public class BeneficiariesViewModelTests
{
    ...
    public async Task LoadBeneficiaries_WhenResponseIsValid_PopulatesViewModel()
    {
        ...
        _apiClient
            .Setup(gets => gets.GetAsync<List<BeneficiaryDataTransferObject>>(It.IsAny<string>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(data);
