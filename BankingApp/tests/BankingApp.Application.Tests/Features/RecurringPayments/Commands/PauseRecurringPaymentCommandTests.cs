...
public sealed class PauseRecurringPaymentCommandTests
{
    ...
    public async Task Handle_WhenPaymentNotFound_ShouldReturnNotFoundError()
    {
        ...
        PauseRecurringPaymentCommandHandler handler = CreateHandler();
        var command = new PauseRecurringPaymentCommand(TestUserId, TestPaymentId);
    ...
    [Fact]
    public async Task Handle_WhenValid_ShouldPausePaymentAndSaveChanges()
    {
        // Arrange
        CancellationToken cancellationToken = new CancellationTokenSource().Token;
    ...
    private PauseRecurringPaymentCommandHandler CreateHandler()
    {
        return new PauseRecurringPaymentCommandHandler(_recurringPaymentRepositoryMock.Object, _unitOfWorkMock.Object);
    }
