...
/// <summary>
///     Unit tests for <see cref="InputRules" />.
/// </summary>
public class InputRulesTests
{
    ...
    {
        // Act & Assert
        InputRules.IsValidEmail(email).Should().BeFalse();
    }
    ...
    {
        // Act & Assert
        InputRules.IsValidEmail(email).Should().BeTrue();
    }
    ...
    {
        // Act & Assert
        InputRules.IsStrongPassword(password).Should().BeTrue();
    }
    ...
    {
        // Act & Assert
        InputRules.IsStrongPassword(password).Should().BeFalse();
    }
    ...
    {
        // Act & Assert
        InputRules.IsValidOtp(otp).Should().BeTrue();
    }
    ...
    {
        // Act & Assert
        InputRules.IsValidOtp(otp).Should().BeFalse();
    }
    ...
    {
        // Act & Assert
        InputRules.IsValidPhoneNumber(phone).Should().BeTrue();
    }
    ...
    {
        // Act & Assert
        InputRules.IsValidPhoneNumber(phone).Should().BeFalse();
    }
    ...
    {
        // Act & Assert
        InputRules.NormalizePhoneNumber(phone).Should().Be(expected);
    }
    ...
    {
        // Act & Assert
        InputRules.NormalizePhoneNumber(phone).Should().BeNull();
    }
    ...
    {
        // Act & Assert
        InputRules.NormalizePhoneNumber("2025550123", "US").Should().Be("+12025550123");
    }
    ...
    {
        // Act & Assert
        InputRules.PasswordsMatch(firstPassword, secondPassword).Should().Be(expected);
    }
}