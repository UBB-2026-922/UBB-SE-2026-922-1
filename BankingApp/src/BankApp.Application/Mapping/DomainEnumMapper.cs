...
using ApplicationCardStatus = BankApp.Application.Enums.CardStatus;
using ApplicationCardType = BankApp.Application.Enums.CardType;
using ApplicationNotificationType = BankApp.Application.Enums.NotificationType;
using ApplicationTransactionDirection = BankApp.Application.Enums.TransactionDirection;
using ApplicationTransactionStatus = BankApp.Application.Enums.TransactionStatus;
using ApplicationTwoFactorMethod = BankApp.Application.Enums.TwoFactorMethod;
using DomainCardStatus = BankApp.Domain.Enums.CardStatus;
using DomainCardType = BankApp.Domain.Enums.CardType;
using DomainNotificationType = BankApp.Domain.Enums.NotificationType;
using DomainTransactionDirection = BankApp.Domain.Enums.TransactionDirection;
using DomainTransactionStatus = BankApp.Domain.Enums.TransactionStatus;
using DomainTwoFactorMethod = BankApp.Domain.Enums.TwoFactorMethod;
