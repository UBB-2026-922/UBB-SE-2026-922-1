...
/// </summary>
public class AccountOverviewRepository : IAccountOverviewRepository
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="AccountOverviewRepository" /> class.
    /// </summary>
    ...
    public AccountOverviewRepository(
    ...
    public ErrorOr<List<Transaction>> GetRecentTransactions(
        int accountId,
        int limit = IAccountOverviewRepository.DefaultRecentTransactionLimit)
    {
