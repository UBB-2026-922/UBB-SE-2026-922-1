...
public class ForexService : IForexService
{
    ...
    private readonly IForexRepository _exchangeRepository;
    ...
    public ForexService(IForexRepository exchangeRepository)
    {
        _exchangeRepository = exchangeRepository;
    }

    /// <inheritdoc />
    public ErrorOr<ForexTransactionResponse> GetRatePreview(
    ...
    /// <inheritdoc />
    public ErrorOr<ForexTransactionResponse> ExecuteExchange(ForexTransactionRequest request)
    {
