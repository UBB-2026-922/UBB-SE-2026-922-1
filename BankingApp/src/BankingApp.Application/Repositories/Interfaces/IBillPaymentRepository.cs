...
public interface IBillPaymentRepository
{
    ...
    public Task<IEnumerable<Biller>> GetBillersAsync();
    ...
    public Task<Biller?> GetBillerByIdAsync(int billerId);
    ...
    public Task AddPaymentAsync(BillPayment payment);
    ...
    public Task<IEnumerable<BillPayment>> GetUserPaymentHistoryAsync(int userId);
    ...
    public Task<IEnumerable<SavedBiller>> GetSavedBillersAsync(int userId);
    ...
    /// <returns>A task representing the operation.</returns>
    public Task AddSavedBillerAsync(SavedBiller savedBiller);
