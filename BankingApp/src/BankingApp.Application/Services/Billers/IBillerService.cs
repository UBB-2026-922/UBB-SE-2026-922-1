...
public interface IBillerService
{
    ...
    ErrorOr<List<BillerDto>> GetBillerDirectory();
    ...
    ErrorOr<List<BillerDto>> SearchBillers(string searchTerm, string? category = null);

    /// <summary>Returns all billers saved by the specified user.</summary>
    /// <param name="userId">The user identifier.</param>
    /// <returns>The list of saved biller DTOs.</returns>
    ErrorOr<List<SavedBillerDto>> GetSavedBillers(int userId);
    ...
    ErrorOr<SavedBillerDto> SaveBiller(int userId, SaveBillerRequestDto request);
