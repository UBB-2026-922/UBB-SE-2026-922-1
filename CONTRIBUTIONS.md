...
29. Keep test data explicit and local to the test unless sharing it removes real duplication without hiding intent.
30. Do not introduce alternate databases or infrastructure providers in tests unless they are already approved for the project.
